...
```sh
scp -r deploy deploy@92.5.105.170:/tmp/
ssh deploy@92.5.105.170 'cd /tmp && ./deploy/bootstrap-vps.sh --url http://92.5.105.170:8080'
```
...
| `ssh-key` | the private key for `deploy@92.5.105.170` |
